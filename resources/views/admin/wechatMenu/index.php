...
<?= $block->js() ?>
<script>
  require(['plugins/wechat/js/admin/wechat-menus', 'css!plugins/wechat/css/admin/wechat-menus', 'plugins/link-to/js/link-to', 'form', 'plugins/admin/js/data-table', 'jquery-deparam'], function (menu, linkTo) {
    menu.index({
      linkTo: linkTo
    });
  });
